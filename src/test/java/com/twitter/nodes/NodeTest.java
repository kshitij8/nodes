...
public class NodeTest extends NodeTestBase {
  ...
  public void testFlatMap5() throws Exception {
    ...
    Node<Integer> flatMappedNode = Node.flatMap5("FlatMap5", first, second, third, fourth, fifth,
            (result1, result2, result3, result4, result5) -> Future.value(result1 + result2 + result3 + result4 + result5));
  ...
  public void testFlatMap6() throws Exception {
    ...
    Node<Integer> flatMappedNode = Node.flatMap6("FlatMap6", first, second, third, fourth, fifth, sixth,
            (result1, result2, result3, result4, result5, result6) -> Future.value(result1 + result2 + result3 + result4 + result5 + result6));
  ...
  public void testFlatMap7() throws Exception {
    ...
    Node<Integer> flatMappedNode = Node.flatMap7("FlatMap7", first, second, third, fourth, fifth, sixth, seventh,
            (result1, result2, result3, result4, result5, result6, result7) -> Future.value(result1 + result2 + result3 + result4 + result5 + result6 + result7));
  ...
  public void testFlatMap8() throws Exception {
    ...
    Node<Integer> flatMappedNode = Node.flatMap8("FlatMap7", first, second, third, fourth, fifth, sixth, seventh, eighth,
            (result1, result2, result3, result4, result5, result6, result7, result8) -> Future.value(result1 + result2 + result3 + result4 + result5 + result6 + result7 + result8));
